...
public class AsteroidUUIDS {
    ...
    public static final UUID EXTERNAL_APP_MESSAGE_SERVICE_UUID  = UUID.fromString("0000A071-0000-0000-0000-00A57E401D05");
    public static final UUID EXTERNAL_APP_MESSAGE_PUSH_MSG_CHAR = UUID.fromString("0000A001-0000-0000-0000-00A57E401D05");
}
